...
\newcommand{\autor}{Leo Kattenbeck}
\newcommand{\studiengang}{Media Engineering}  % {Informatik,Wirtschaftsinformatik,Medieninformatik}
\newcommand{\matrikelnr}{3677500}
...
\usepackage[english,ngerman]{babel}  % German as main language
...
\renewcommand{\lstlistlistingname}{Listings Verzeichnis}  % change for German thesis
\lstlistoflistings
\cleardoublepage
